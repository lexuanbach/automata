...
public class GraphViz
{
  ...
  */
 private final static String cfgProp = "/home/bachdylan/workplace/graph/config.properties";
  ...
  */
private static String TEMP_DIR = "/home/bachdylan/workplace/graph/";
...
private static String DOT = configFile.getProperty("dotFor" + osName);
  ...
  * @return The file (as a File object) that contains the source of the graph.
  */
 public void writeDotSourceToFile(String str, String file) throws java.io.IOException
 {
     File temp;
     try {
         temp = new File(file);
